    ...
    partial class GLTFExporter
    {
        private void ExportMaterial(BabylonMaterial babylonMaterial, GLTF gltf)
        {
            ...
            else if (babylonMaterial.GetType() == typeof(BabylonStandardMaterial))
            {
                ...
                //System.Windows.Forms.MessageBox.Show(string.Format("gltfPbrMetallicRoughness:{0}", gltfPbrMetallicRoughness.baseColorFactor[3]));
                // Metallic roughness
        ...
        private void getAlphaMode(BabylonStandardMaterial babylonMaterial, out string alphaMode, out float? alphaCutoff)
        {
            ...
            alphaMode = null;
            alphaCutoff = null;
            //System.Windows.Forms.MessageBox.Show(string.Format("babylonMaterial.transparencyMode:{0}", babylonMaterial.transparencyMode));
